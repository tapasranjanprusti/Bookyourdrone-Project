...
<table class="table table-bordered" id="dataTable">
      <thead>
        ...
        <th class="tblthcss">SI No</th>
          ...
          <th class="tblthcss">CoPilot Name</th>
      ...
      @php
        ...
        <td class="tbltdcss">{{$i}}</td>
          <td class="tbltdcss">{{$compord->date}}</td>
          <td class="tbltdcss">{{$compord->order_id}}</td>
          <td class="tbltdcss">{{$compord->pilot_name}}</td>
          <td class="tbltdcss">{{$compord->copilot_name}}</td>
          
          <td><a href="{{ route('Admin.viewCompleteOrder', ['id' => $compord->order_id]) }}"><i class="fa fa-eye"></i></a></td>
