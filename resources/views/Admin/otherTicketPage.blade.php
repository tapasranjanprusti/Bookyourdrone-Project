...
<table class="table table-bordered" id="dataTable">
      ...
      <tbody>
        ...
        $i=1;
        @endphp
        @foreach($all_otherticket as $othr)
       
        <tr>
        <td class="tbltdcss">{{$i}}</td>
          <td class="tbltdcss">{{$othr->user_code}}</td>
          <td class="tbltdcss">{{$othr->order_id}}</td>
          <td class="tbltdcss">{{$othr->name}}</td>
          <td class="tbltdcss">{{$othr->email}}</td>
          <td class="tbltdcss">{{$othr->mob}}</td>
          <td class="tbltdcss">{{$othr->msg}}</td>
