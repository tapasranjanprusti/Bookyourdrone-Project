...
<table class="table table-bordered" id="dataTable">
      ...
      <tbody>
        ...
        $i=1;
        @endphp
        @foreach($all_enquery as $enrgy)
       
        <tr>
        <td class="tbltdcss">{{$i}}</td>
          <td class="tbltdcss">{{$enrgy->user_code}}</td>
          <td class="tbltdcss">{{$enrgy->order_id}}</td>
          <td class="tbltdcss">{{$enrgy->name}}</td>
          <td class="tbltdcss">{{$enrgy->email}}</td>
          <td class="tbltdcss">{{$enrgy->mob}}</td>
          <td class="tbltdcss">{{$enrgy->msg}}</td>
