...
<table class="table table-bordered" id="dataTable">
      ...
      <tbody>
        ...
        <td class="tbltdcss">{{$i}}</td>
          <td class="tbltdcss">{{$feedback->user_code}}</td>
          <td class="tbltdcss">{{$feedback->order_id}}</td>
          <td class="tbltdcss">{{$feedback->name}}</td>
          <td class="tbltdcss">{{$feedback->email}}</td>
          <td class="tbltdcss">{{$feedback->mob}}</td>
          <td class="tbltdcss">{{$feedback->msg}}</td>
