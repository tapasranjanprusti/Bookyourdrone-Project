...
<table class="table table-bordered" id="dataTable">
      ...
      <tbody>
        ...
        $i=1;
        @endphp
        @foreach($all_refund as $refund)
       
        <tr>
        <td class="tbltdcss">{{$i}}</td>
          <td class="tbltdcss">{{$refund->user_code}}</td>
          <td class="tbltdcss">{{$refund->order_id}}</td>
          <td class="tbltdcss">{{$refund->name}}</td>
          <td class="tbltdcss">{{$refund->email}}</td>
          <td class="tbltdcss">{{$refund->mob}}</td>
          <td class="tbltdcss">{{$refund->msg}}</td>
